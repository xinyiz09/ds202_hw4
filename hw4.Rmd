...
dat2
mycolor <- c("max" = "red", "min" = "purple", "other" = "grey50")
ggplot(dat2, aes(x=Diet, y=weightgain, color=new)) + scale_color_manual("Status", values = mycolor) + geom_jitter(width=0.1) + ylim(0, 350) + xlab("Diet number")
